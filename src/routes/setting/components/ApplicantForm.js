...
const ApplicantForm = ({ classes, authFields }) => {
  return (
    <>'     '<Title medium={true} isStatic={true} margin="0 0 15px 0" text="register_app_personal" />'     '<div className={classes.picTitle}><T>register_app_photo</T></div>'     '<Field name="photo" component={ImageUploadField} />'
     '<div style={{ marginTop: '26px' }} className={classes.field}>
      ...
      <TW>
          ...
          <>'             '<Field
                 ...
                 </div>'     '<div className={classes.contacts}>
      <Title medium={true} isStatic={true} margin="0 0 15px 0" text="footer_contact" />
