...
const EmployerForm = ({ classes, userData, authFields }) => {
  ...
  return (
    <>'     '<Title isStatic={true} medium={true} margin="0 0 15px 0" text="main_info" />'     '<div className={classes.picTitle}><T>company_photo</T></div>'     '<TW>
      {lang => (
        <Field
          name="logo"
      ...
      <TW>
          ...
          <Field
            ...
            />
                 ...
                 </div>'     '<div className={classes.fieldOne}>
      <TW>
                     {lang => (
          <Field
                         name="trademark"
     ...
     '<div className={classes.fieldOne}>
      ...
      </div>'     '<div className={classes.line} />'     '{authFields}'     '<RenderOrNull value={managerName}>
      <div className={classes.managerWrap}>
          <Title medium={true} isStatic={true} margin="0 0 15px 0" text="company_personal_manager" />
