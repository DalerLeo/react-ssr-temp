...
export default (props) => {
  return (
    <SvgIcon width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5.5 1.83334L2.75 5.50001V18.3333C2.75 18.8196 2.94315 19.2859 3.28697 19.6297C3.63079 19.9735 4.0971 20.1667 4.58333 20.1667H17.4167C17.9029 20.1667 18.3692 19.9735 18.713 19.6297C19.0568 19.2859 19.25 18.8196 19.25 18.3333V5.50001L16.5 1.83334H5.5Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M2.75 5.5H19.25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M14.6668 9.16666C14.6668 10.1391 14.2805 11.0717 13.5929 11.7594C12.9053 12.447 11.9726 12.8333 11.0002 12.8333C10.0277 12.8333 9.09507 12.447 8.40744 11.7594C7.7198 11.0717 7.3335 10.1391 7.3335 9.16666" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </SvgIcon>
